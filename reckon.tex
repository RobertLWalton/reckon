...
A \key{number} is a sequence of digits,
...
the double quote character (\ttnbkey{"}), where \skey{graphic character}s
...
a number character if it is followed by a digit,
...
as \verb|7| and the input \verb|15/2| may also be output as \verb|7.5|.
...
A quoted symbol not containing a {\em special-character-representative}
is similarly stored.  Thus an unquoted symbol not containing
a {\em special-character-representative}
