...
to parse the subexpression they surround.  If the parser recognizes
operators, the set of recognized operators and their precedence is
controlled.
...
Special marks are recognized only if \verb|[[ ]]| surround a
{\em raw-subexpressions}, and not if \verb|[ ]| surround the
subexpression.
