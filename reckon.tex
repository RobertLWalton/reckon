...
\key{lexeme-dictionary-entry-list} \\
		     ...
		     $|$ & {\em lexeme-dictionary-entry-list} \verb|,|
		           {\em lexeme-dictionary-entry}
		     \end{tabular} \\[1ex]
\key{lexeme-dictionary-entry} ::= {\em replaced-lexeme} {\em lexeme-replacement}
					\\[1ex]
\key{replaced-lexeme} ::= {\em lexeme} \\[1ex]
\key{lexeme-replacement} ::= {\em replacing-lexemes} \\[1ex]
\key{replacing-lexemes} ::= {\em lexemes} \\[1ex]
\key{lexeme-function-definition} \\
	\hspace*{1in}::= \verb|define lexeme function|
				{\em function-name} \\[1ex]
\key{function-name} ::= {\em lexemes}
\end{indpar}
