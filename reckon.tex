...
\begin{tabular}{l}
\emkey{object-list} ::= {\em single-attribute-value}\STAR{}
\end{tabular}
...
not used as {\em single-attribute-values} and \TT{=>} and \TT{=>{}>}
are not used as {\em attribute-assignment-operators}.
...
The {\em single-attribute-values} in a {\em object-list}
...
an {\em expression}, while a {\em single-attribute-value} can be
any {\em expression}
