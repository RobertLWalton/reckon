...
constraints.  Some constraints are logical expressions that
must evaluate to true in order for the expression definition match to succeed.
Other constraints require that subexpressions match patterns or each other
in order for the expression definition match to succeed.
Still other constraints provide default values for missing
arguments.
