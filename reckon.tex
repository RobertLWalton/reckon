...
Expression structure is affected by four special marks.
...
optional qualifier marks (\ref{TBD}).
...
Some of the matching lexemes above affect evaluation (eval).
...
matching lexemes and the \verb|<:>| reorder, \verb|::>| remainder,
