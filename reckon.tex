...
precedence & rerformatter	& type	& operators	& meaning 
\\[2ex]
+0000	& \ttkey{assign}	& \tt nofix	& \ttkey{=}	& assignment \\
	&			&		& \ttkey{,}	& separator \\
	&			&		& \ttnbkey{<--}	& define \\
	&			& \tt infix	& \ttkey{\LEFTBRACKET}
								& block \\
+1000	& \ttkey{logical}	& \tt nofix	& \ttkey{AND}	& logical and \\
	&			&		& \ttkey{OR}	& logical or \\
	&			&		&  \ttkey{NOT}  & logical not \\
+2000 	& \ttkey{compare}	& \tt nofix	&  \ttnbkey{==}	& equal \\
	&			&		& \ttnbkey{/=}  & not equal \\
	&			&		& \ttnbkey{!=}	& ditto \\
	&		      	&		& \ttnbkey{<}	& less than \\
	&			&		& \ttnbkey{<=}	& less than or
	...
	&			&		& \ttnbkey{>=}	& greater than
								  or equal \\
	&			&		& \ttnbkey{=>}	& ditto \\
+3000	& \ttkey{sum}		& \tt infix	&  \ttnbkey{+}	& addition \\
	&			&		& \ttnbkey{-}	& subtraction \\
+3100	& \ttkey{product}	& \tt infix	&  \ttnbkey{*}
							    & multiplication \\
	&			&		& \ttnbkey{/}	& division \\
+9999	& \ttkey{minus}		& \tt prefix	&  \ttnbkey{-}	& minus \\
+9999	& \ttkey{plus}		& \tt prefix	&  \ttnbkey{+}	& plus \\
+9999	& \ttkey{objname}	& \tt prefix	&  \ttnbkey{@}	& object name \\
\end{tabular}
