...
An \key{atom} is a symbol, a number, or a sequence of 0 or 2 or more atoms.
A single atom is treated as if were a sequence of 1 atom, itself, and
when atoms are being treated as sequences of atoms, they are referred to
as `\skey{label}s'.
