...
whose \TT{.initiator} is not \TT{"("}.  A `mkey{key}{of a pattern}'
of a {\em pattern} is any key of one of its {\em pattern-clauses}.
...
key of the original folded pattern, and no element that is a syntax
