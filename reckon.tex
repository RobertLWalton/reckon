...
\begin{indpar}
\emkey{number} := {\em numeric} \\[1ex]
\emkey{symbol} ::= {\em word} $|$ {\em mark} $|$ {\em separator}
               $|$ {\em quoted-string} \\[1ex]
...
expressed as seconds relative to January 1, 0000,
...
\emkey{scientific-numeric} ::= {\em integral-numeric}
       $|$ {\em integral-numeric}\TT{.}{\em fractional-numeric} \\[1ex]
\emkey{integral-numeric} ::= {\em digit}\PLUS{}
	$|$ {\em digit}\QMARK{} {\em digit}\QMARK{} {\em digit}
	    \{ \TT{,} {\em digit} {\em digit} {\em digit} \}\PLUS{} \\[1ex]
\emkey{fractional-numeric} ::= {\em digit}\PLUS{}
	$|$ \{ {\em digit} {\em digit} {\em digit} \TT{,} \}\PLUS{}
...
a {\em integral-numeric} or the beginning of a {\em fractional-numeric}.
...
\emkey{date} \begin{tabular}[t]{rl}
	     ::= & {\em month}\TT{/}{\em day}\TT{/}{\em year}
	           {\em era}\QMARK{} \\
	     $|$ &  {\em day} {\em month-name} {\em year} {\em era}\QMARK{} \\
	     $|$ &  {\em day} {\em month-name} {\em year-name}
	            {\em era}\QMARK{} \\
	     $|$ &  {\em year-name}
	     \end{tabular}
\label{DATE}\\[1ex]
\emkey{month} ::=  {\em digit}\QMARK{} {\em digit} \\[1ex]
\emkey{month-name}
    \begin{tabular}[t]{rl}
    ...
    \end{tabular} \\[1ex]
\emkey{day} ::=  {\em digit}\QMARK{} {\em digit} \\[1ex]
\emkey{year}
    \begin{tabular}[t]{rl}
    ::= & {\em digit}\STAR{}
          {\em digit} {\em digit} {\em digit} {\em digit}  \\
    $|$ & {\em digit} {\em digit}
    \end{tabular} \\[1ex]
\emkey{year-name} ::=  \TT{'} {\em digit} {\em digit} \\[1ex]
