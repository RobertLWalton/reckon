...
\begin{indpar}[0.1in]
\begin{tabular}{@{}p{1.5in}@{\hspace*{0.3in}}p{4.5in}@{}}
    \begin{tabular}[t]{@{}l@{}}
...
\begin{tabular}{@{}p{1.5in}@{\hspace*{0.3in}}p{4.5in}@{}}
    ...
    \end{tabular}
    & Consecutive numbers (e.g., \verb|42 3/4|) are regonized as
...
\begin{tabular}{@{}p{1.5in}@{\hspace*{0.3in}}p{4.5in}@{}}
    ...
    expression consisting of a sequence of lexemes and subexpressions
    and finds implied subexpressions and other structure in it.
\end{tabular} \\[2ex]
\begin{tabular}{@{}p{1.5in}@{\hspace*{0.3in}}p{4.5in}@{}}
    \begin{tabular}[t]{@{}l@{}}
    Operator Parsing\\
    ...
    \end{tabular}
    & Operator parsing is a particular brand of parsing that recognizes
...
\begin{tabular}{@{}p{1.5in}@{\hspace*{0.3in}}p{4.5in}@{}}
    ...
    (\secref{TEXT-PARSER})
    \end{tabular}
    & Text parsing is a particular brand of parsing that recognizes
      sentence terminators (e.g., \verb|.| and \verb|?|) and
      phrase separators (e.g., \verb|,| and \verb|;|) and produces
      expressions the represent sentences and paragraphs.
\end{tabular}
\end{indpar}
