...
\ikey{LEXEME-DICTIONARY-DEFINITION}{lexeme-dictionary-definition} \\
	\hspace*{0.5in}::= \verb|define lexeme dictionary|
...
\begin{indpar}
\begin{verbatim}
define lexeme dictionary ENTRIES <== n-tuple ENTRIES of expressions

define lexeme function NAME <== expression NAME
\end{verbatim}
\end{indpar}
...
\key{lexeme-dictionary-entry} ::=
	{\em replaced-lexeme} \verb|=>| {\em lexeme-replacement}
\end{indpar}
