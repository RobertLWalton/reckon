...
100	& \ttkey{sentence}	& \tttkey{s}	& sentence \\
	...
	&			& \ttkey{!}	& sentence terminator \\
	&			& \ttkey{?}	& sentence terminator \\
200	& \ttkey{separator}	& \ttkey{;}	& subsentence separator \\
	&			& \ttkey{:}	& subsentence separator \\
300	& \ttkey{separator}	& \ttnbkey{--}	& phrase separator \\
	& 			& \ttnbkey{---}	& phrase separator \\
400	& \ttkey{separator}	& \ttkey{,}	& phrase separator \\
\end{tabular}
...
\ttmkey{text-prefix}{reformatter} \hfill \OP{p} ~~~ \OP{q}

\begin{indpar}[0.5em]
Here `\verb|<p>|' and `\verb|<q>|' have different
precedences, and so cannot appear together in the same expression.
...
\ttmkey{separator}{reformatter} \hfill \ttmnbkey{--}{reformatting}
...
{\em subexpression} {\em subexpression}$^\star$
\end{center}
where all the {\em operators} must be the same (i.e., you cannot
mix `{\tt ;}' or `{\tt --}' and `{\tt ---}' in the same expression).
...
\ttmkey{foobar}{reformatter} \hfill \OP{r}
