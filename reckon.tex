...
\\[1ex]
\emkey{year} ::= {\em short-year} $|$ {\em long-year}
\\[1ex]
\emkey{short-year} ::= {\em digit} {\em digit}
\\[1ex]
\emkey{long-year} ::= {\em digit}\STAR{}
...
\emkey{month-name}
    ...
    \end{tabular}
\\[1ex]
\emkey{year-name} ::=  {\em long-year} $|$ {\em short-year-name}
\\[1ex]
\emkey{short-year-name} ::=  \TT{'} {\em digit} {\em digit}
\\[1ex]
\emkey{weekday}
    \begin{tabular}[t]{rl}
    ::= & \TT{Mon} $|$ \TT{Monday} \\
...
Two {\em digit} {\em short-years} refer to years within the
$[-49,+50]$ range from of the current year.  They are never output, but may be
input.  {\em Short-years} that might refer to years in the
ranges $[-49,-41]$ or $[41,50]$ from the current year
