...
The raw object representation is indicated by logical lines beginning
with an {\em object-identifier} lexeme, which consists of a `\TT{@}'
followed by digits.
