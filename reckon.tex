...
In many contexts an unquoted symbol may be quoted without changing
...
a special interpretation by a parser the symbol should be quoted
...
Lexical parsing only affects at short sequences of lexemes, and is
...
number of empty columns to the left of the
first non-white-space character in the line.
