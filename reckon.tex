...
\key{indentation-beginning} ::= see text, \pagref{INDENTATION-BEGINNING}
				and \pagref{INDENTATION-BEGINNING2} \\[1ex]
\key{indentation-separator} ::= see text, \pagref{INDENTATION-SEPARATOR}
				and \pagref{INDENTATION-SEPARATOR2} \\[1ex]
\key{indentation-end} ::= see text, \pagref{INDENTATION-END}
...
line but the first.
An \key{indentation-beginning}\label{INDENTATION-BEGINNING}
is placed after the {\em indentation-mark}
and before the first the line in an {\em indented-subexpression}.
An \key{indentation-end}\label{INDENTATION-END}
is placed after
...
and {\em indentation-ends} are syntactic categories but not lexemes.
