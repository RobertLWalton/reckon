...
to undo their affects.  See \itemref{PARSING-INSTRUCTIONS} for
details.
...
\hspace*{0.2in}\begin{tabular}{llll}

Unit 		& Plural			& Type	     & Equivalent
\\[2ex]
\TT{g}		& 				& continuous \\
\TT{lb}		& \TT{lbs}			& continuous
							& \TT{453.59237 g} \\
\TT{kg}		& 				& continuous & \TT{1000 g} \\
\TT{cm}		& 				& continuous \\
\TT{m}		& 				& continuous & \TT{100 cm} \\
\TT{ft}		& 				& continuous & \TT{30.48 cm} \\
\TT{yd}		& 				& continuous & \TT{91.44 cm} \\
\TT{mi}		& 				& continuous
							& \TT{160934.4 cm} \\
\TT{sec}	& 				& continuous \\
\TT{min}	& 				& continuous & \TT{60 sec} \\
\TT{hr}		& 				& continuous & \TT{3600 sec} \\
\TT{person}	& \TT{persons}, \TT{people}	& discrete   \\
