...
referred to as `\skey{text mark}s'.  Text marks have attributes
such as `{\tt style}', `{\tt weight}', `{\tt indent}', and `{\tt adjust}'.
These are used to format the text for printing and display.  Text marks
...
and the {\tt .label} and {\.tt label} attribute values.
