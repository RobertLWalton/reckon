...
\key{next-variable} ::= \ttkey{next} {\em variable-name} \\[1ex]
...
(\secref{DEFAULT-STATEMENTS}, \secref{BLOCK-ITERATION}).
...
(\secref{DEFAULT-STATEMENTS} and \secref{BLOCK-ITERATION}).

\subsection{Default Statements}
\label{DEFAULT-STATEMENTS}

The \ttkey{default} {\em statement-qualifier} modifies group.
A statement qualified by {\tt default}
is called a \key{default statement}.  Such {\em statements} in a {\em group}
...
consists of all non-default statements and all active default statement,
continues executing, until no more non-default or active default statements
can be executed.
...
\secref{DEFAULT-STATEMENTS}, \secref{BLOCK-ITERATION}), any
