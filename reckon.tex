...
Hello	  & 		& Hello \\
5.4321	  & /.2/	& 5.43 &
Hello	  & /7/		& Hello\VSP\VSP \\
5.4321	  & /5.2/	& \VSP 5.43 &
Hello	  & /7c/	& \VSP Hello\VSP \\
5.4321	  & /6.2/	& \VSP \VSP 5.43 &
Hello	  & /7r/	& \VSP\VSP Hello \\
5.4321	  & /6.2c/	& \VSP 5.43\VSP &
\end{tabular}
\end{indpar}
...
The items are presented in groups many of which conflict with each other;
see the rules below for resolving conflicts. \\
...
\BEGINGROUP{Bold Face Group}
\GROUPENTRY{b} bold face \\
\GROUPENTRY{!b} non-bold face [default] \\
\ENDGROUP \\
\BEGINGROUP{Italics Group}
\GROUPENTRY{i} italics \\
\GROUPENTRY{!i} non-italics [default] \\
\ENDGROUP \\
\BEGINGROUP{Font Group}
\GROUPENTRY{rm} roman [default] \\
\GROUPENTRY{tt} typewriter \\
\ENDGROUP \\
...
\GROUPENTRY[places]{.}
    right adjust with {\em places} decimal places \\
\GROUPENTRY[places]{0.}
...
\GROUPENTRY[time-format]{T}
    ...
    conflicts with \TT{\%}, \TT{\$}, and \TT{,} \\
\ENDGROUP \\
\BEGINGROUP{Per Cent Sign Group}
\GROUPENTRY{\%} multiply numbers by 100 and add a \% sign \\
\GROUPENTRY{!\%} undo ditto \\
\ENDGROUP \\
\BEGINGROUP{Dollar Sign Group}
\GROUPENTRY{\$} add \$ signs to numbers; \GROUPNEWLINE
...
\GROUPENTRY{!,} undo ditto \\
\ENDGROUP \\
\BEGINGROUP[(no conflicts)]{Spacing Group}
