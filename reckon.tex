...
\subsubsubsection{Operator Flags}\ttmindex{flag}{of operator}
...
{\bf prefix}\index{prefix flag@{\tt prefix} flag}%
\label{PREFIX}~~~~~
{\bf infix}\index{infix flag@{\tt infix} flag}%
\label{INFIX}~~~~~
{\bf postfix}\index{postfix flag@{\tt postfix} flag}%
\label{POSTFIX}~~~~~
These flags determine whether the operator is treated as
a prefix, infix, or postfix operator.  The operator can be two
out of these three.  By default an operator is infix only.
