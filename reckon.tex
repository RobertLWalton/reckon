...
\emkey{pattern-term} \begin{tabular}[t]{rl}
            ...
            ::= & {\em pattern-factor} {\em pattern-factor}$^\star$
	    		\ttmkey{...?}{in pattern} \\
	    \end{tabular} \\[1ex]
\emkey{pattern-factor} ::= {\em atom} $|$ {\em pattern-object}
\end{indpar}%
\label{PATTERN}
...
match fails.  If pattern matching succeeds, it generates syntax equations.
Otherwise the matching process continues
by generating constraint syntax equations and then searching for
