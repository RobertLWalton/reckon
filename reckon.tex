...
If a {\em pattern} attribute has an attribute value that is a {\em pattern},
this attribute value {\em pattern} must be unfolded in its containing
unfolded {\em pattern}.  If a {\em pattern} attribute that has the
`\TT{?}' flag appears in the unfolded {\em pattern}, the `\TT{?}' flag
is removed from the attribute in the unfolded {\em pattern}.
