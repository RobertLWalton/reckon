...
may be induced by operators: see \ref{PARSING}.
...
that are added to the lexical context used to parse
subsequent subexpressions of $E$. TBD
...
\[
    \left[ \begin{array}{l}
	   ...
	   \verb|ascending| \\
	   \verb|with| \left[ \begin{array}{l}
			      \verb|key| \left[ \verb|weight| \right. \\
			      \verb|comparitor| \left[ \verb|<| \right. \\
			      \end{array}
		       \right. \\
           \end{array}
    \right.
...
\[
    \left[ \begin{array}{l}
        \verb|-EMPTY-| \left[ \verb|x| \right. \\
        \verb|-REST-| \left[ = \left[ \begin{array}{l}
	    \verb|-EMPTY-| \left[ \begin{array}{l}
		\verb|-EMPTY-| \left[ \verb|y| \right. \\
		\verb|-REST-| \left[ \verb|*| \left[ \verb|y| \right. \right.
	    \end{array} \right. \\
	    \verb|-REST-| \left[ \verb|+| \left[ \verb|5| \right. \right.
