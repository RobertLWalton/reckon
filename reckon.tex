...
When an expression definition applies to an expression, variables in the
expression definition are bound to subexpressions of the expression.
...
is returned as the expression value.  If no, an error value describing
...
one of these results is returned as the expression value.  Otherwise,
an error value describing the evaluation is returned as the expression value,
and as the value of any variable in the expression.
...
\item
Evaluate each guard of the definition in left to right order.
