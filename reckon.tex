...
\subsubsection{Primary Character Disambiguation Rules}
...
an {\em opening-character}, or a {\em primary-separator-character}.
Otherwise it is a {\em word-character}.

{\bf Primary Separator Rule.}\index{Primary Separator Rule}
A {\em primary-separator-character} must be in the context of
a pair of matching {\em quotes}.  Otherwise it is a {\em word-character}.

{\bf Angle Rule.}\index{Angle Rule}
An {\em angle-character} must be either proceeded or followed by a copy
...
Other rules of PCASL cause {\em white-space} following an
...
A primary word may be converted to a word lexeme with the identical
set of characters, or may have either its first or last character or
both removed.
