...
\begin{tabular}{l}
\emkey{number} ::= see \pagref{NUMBER}
\end{tabular}
...
{\em raw-double-attribute-representation}, must be represented with exactly
...
Any {\em single-attribute-values} following the {\em raw-object-header}
