...
line, in which case they are indicated by announcing the beginning
of the non-continuation line by the two lexemes `\TT{<\#> <*>}'
instead of just one `\TT{<*>}' lexeme.  Thus
...
use of symbols specially recognized by the parser
are not allowed in these, a few exceptions.
