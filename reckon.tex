...
changes, the $\theta$ window is updated, and every time the description
...
a particular kind of object.  A block is a particular kind of expression,
...
The first object named in an output stream is assigned the name
