...
\emkey{expression-definition} ::=
	{\em pattern} \TT{<-{}-} {\em qualifier-list-option} {\em block-option}
	\\[1ex]
...
\emkey{qualifier-list-option} ::= {\em empty} $|$ {\em qualifier-list} \\[1ex]
\emkey{qualifier-list}
    ::= {\em qualifier} \{ \TT{,} {\em qualifier} \}\STAR{} \\[1ex]
\emkey{qualifier} ::= \TT{,}{\em -subexpression}
	~~~ [see {\em O-subexpression}, \pagref{O-SUBEXPRESSION}] \\[1ex]
...
\emkey{pattern-equation} ::= {\em syntax-expression}
		\TT{:=\~~} {\em qualifier-pattern}
	        ~~~ [see \pagref{PATTERN-EQUATIONS}]
		\\[1ex]
{\em qualifier-pattern} ::= {\em pattern-object}
	~~~ [see \pagref{PATTERN-OBJECT}] \\[1ex]
...
qualifier syntax and pattern equations in the definition
