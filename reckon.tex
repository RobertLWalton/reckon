...
into a list which has the following extra attributes supplied by the
named brackets: \ttdkey{text-type} \ttdkey{label}.
...
The list is then the reformatted list for the sentence.
...
a list whose {\tt .text-type} is `\ttmkey{phrase}{\tt .text-type}' and whose
{\tt .separator} is the {\em operator}.  The elements of this list
are the lists of {\em subexpressions} between operators, though if there
