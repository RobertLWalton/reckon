...
Radix Number Identification (\secref{RADIX-NUMBER-IDENTIFICATION}) \\
Scientific Number Identification (\secref{SCIENTIFIC-NUMBER-IDENTIFICATION}) \\
...
\subsubsection{Radix Number Identification}
\label{RADIX-NUMBER-IDENTIFICATION}
...
\subsubsection{Scientific Number Identification}
\label{SCIENTIFIC-NUMBER-IDENTIFICATION}
