...
\end{enumerate}
All the {\em variable-names} in the block are one of these kinds
of variables.
...
\verb|    <--- is an integer X, is an integer Y|~~~{\em block}
\end{indpar}
...
that are {\em variable-names}.

If a {\em name} that is not a {\em variable-name} of the block
appears in a {\em value-expression}, that {\em name} does not
name a variable, and it must be
