...
The following standard lexeme dictionaries and functions have
definitions in the initial parsing stack.  These are ordered in the
...
\item
\verb|define lexeme dictionary [standard lexeme dictionary]|
