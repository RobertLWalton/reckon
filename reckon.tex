...
Expression inference is part of expression evaluation and is done by
running an inference algorithm on an expression and a set of inference rules.
This algorithm matches the expression to an inference rule, and then generates
a new set of expressions that must be inferred in order for the matching
to be a success.
