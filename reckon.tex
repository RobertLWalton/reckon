...
Note that the guards of an expression are always evaluted from left to
...
There are muttable contexts that are doubly linked lists which can be iterated
