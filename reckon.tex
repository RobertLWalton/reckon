...
\begin{Graph}
    \Gvariable{\CurlyBra ROOT\CurlyKet} \\
    \begin{Gsimplechild}{-ARITY-}
	\Glabel{3} \\
    \end{Gsimplechild} \\
    \begin{Gsimplechild}{0}
	\Glabel{max} \\
    \end{Gsimplechild} \\
    \begin{Gsimplechild}{1}
	\Glabel{x} \\
...
\begin{Graph}
	...
	\Glabel{Prefix} \\
    \end{Gsimplechild} \\
    \begin{Gsimplechild}{2-3}
	\Glabel{Matrix} \\
    \end{Gsimplechild} \\
    \begin{Gsimplechild}{2-3}
	\Glabel{Value}
    \end{Gsimplechild} \\
    \begin{Gsimplechild}{4}
	\Glabel{Postfix}
    \end{Gsimplechild} \\
    \begin{Gsimplechild}{-REST-}
	\Glabel{Runs}
    \end{Gsimplechild} \\
\end{Graph}
\end{center}
...
be reorderable.  These arguments are indicated by argument indices that
...
optional, reorderable, or rest arguments.  Call unification is
