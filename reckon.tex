...
\hspace*{0.8in} & \hspace*{1.2in} & \hspace*{0.8in} & \hspace*{0.6in} \\[-2ex]
...
\hspace*{0.2in}\begin{tabular}{rll@{\hspace*{2em}}l@{\hspace*{2em}}l}
\hspace*{0.8in} & \hspace*{1.2in} & \hspace*{0.8in} & \hspace*{0.6in} \\[-2ex]
+5000	& \TT{summation}	& \TT{infix}	&  \ttkey{+}	& addition \\
	& ~~~~\TT{(`+',`-')}	&		& \ttkey{-}	& subtraction \\
\end{tabular}

\hspace*{0.2in}\begin{tabular}{rll@{\hspace*{2em}}l@{\hspace*{2em}}l}
\hspace*{0.8in} & \hspace*{1.2in} & \hspace*{0.8in} & \hspace*{0.6in} \\[-2ex]
+5100	& \TT{binary}	& \TT{infix}	& \ttkey{/}	& division \\
+5200	& \TT{binary}	& \TT{infix}	& \ttkey{*}
							& multiplication \\
+5300	& \TT{binary}	& \TT{infix}	& \ttkey{\^~}
							& exponentiation \\
\end{tabular}
