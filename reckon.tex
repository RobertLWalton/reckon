...
syntax variable, the syntax variable is replaced by its
value before the pattern equation is processed.
If this cannot be done, the pattern equation is inconsistent.
