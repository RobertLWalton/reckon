...
equivalent to `\TT{|~|\}}' and denotes and empty list.
...
`\TT{text}' selector, and those appropriate to expression parsing are
turned on by the `\TT{expression}' selector.
...
\begin{center}
\begin{tabular}{l@{\hspace*{0.3in}}l@{\hspace*{0.3in}}l@{\hspace*{0.3in}}p{2in}}
\bf Brackets & \bf Selectors & \bf Context Selectors & \bf Usage \\[1ex]
\TT{\{*\ldots*\}} & none & all & comment \\
\TT{`\ldots'} & \TT{text} & all & text \\
\TT{\{!\ldots!\}} & \TT{operator}, \TT{code} & all
    & unevaluated code \\
\TT{\{\{\ldots\}\}} & \TT{operator}, \TT{math} & all
    & unevaluated math expression \\
\TT{[\ldots]} & \TT{operator} & \TT{text} or \TT{math}
    & evaluated expression in text or math expression \\
\end{tabular}
\end{center}
...
the \TT{\{!\ldots!\}} brackets change
the context to have both the `\TT{operator}' and `\TT{code} selectors,
and so forth.
...
\label{THE-OPERATOR-PARSING-PASS}
...
\hspace*{0.8in} & \hspace*{1.0in} & \hspace*{0.6in} & \hspace*{0.6in} \\[-2ex]
...
\hspace*{0.2in}\begin{tabular}{rll@{\hspace*{2em}}l@{\hspace*{2em}}l}
\hspace*{0.8in} & \hspace*{1.0in} & \hspace*{0.6in} & \hspace*{0.6in} \\[-2ex]
-1000	& \ttkey{separator}	& \TT{nofix}	& \ttkey{;}	& separator \\
\end{tabular}

\hspace*{0.2in}\begin{tabular}{rll@{\hspace*{2em}}l@{\hspace*{2em}}l}
\hspace*{0.8in} & \hspace*{1.0in} & \hspace*{0.6in} & \hspace*{0.6in} \\[-2ex]
+0000	& \ttkey{define}	& \TT{nofix}	& \ttkey{<-{}-}	& define \\
	&			& \TT{afix}
	                        & \ttkey{\TT{\{:\ldots:\}}}
				& block \\
\end{tabular}
...
\hspace*{0.2in}\begin{tabular}{rll@{\hspace*{2em}}l@{\hspace*{2em}}l}
\hspace*{0.8in} & \hspace*{1.0in} & \hspace*{0.6in} & \hspace*{0.6in} \\[-2ex]
+1000	& \ttkey{assign}	& \TT{infix}	& \ttkey{=}	& assignment \\
     	&               	&          	& \ttkey{+=}	& increment \\
     	&               	&          	& \ttkey{-=}	& decrement \\
     	&               	&          	& \ttkey{*=}	& multiply by \\
     	&               	&          	& \ttkey{/=}	& divide by \\
...
\hspace*{0.2in}\begin{tabular}{rll@{\hspace*{2em}}l@{\hspace*{2em}}l}
\hspace*{0.8in} & \hspace*{1.0in} & \hspace*{0.6in} & \hspace*{0.6in} \\[-2ex]
+3000	& \ttkey{logical}	& \TT{nofix}	& \ttkey{AND}	& logical and \\
	&			&		& \ttkey{OR}	& logical or \\
...
\hspace*{0.2in}\begin{tabular}{rll@{\hspace*{2em}}l@{\hspace*{2em}}l}
\hspace*{0.8in} & \hspace*{1.0in} & \hspace*{0.6in} & \hspace*{0.6in} \\[-2ex]
+4000 	& \ttkey{compare}	& \TT{infix}	& \ttkey{==}	& equal \\
	&			&		& \ttkey{/=}  & not equal \\
	&			&		& \ttkey{!=}	& ditto \\
	&		      	&		& \ttkey{<}	& less than \\
	&			&		& \ttkey{<=}	& less than or
...
\hspace*{0.2in}\begin{tabular}{rll@{\hspace*{2em}}l@{\hspace*{2em}}l}
\hspace*{0.8in} & \hspace*{1.0in} & \hspace*{0.6in} & \hspace*{0.6in} \\[-2ex]
+5000	& \ttkey{sum}		& \TT{infix}	&  \ttkey{+}	& addition \\
	&			&		& \ttkey{-}	& subtraction \\
\end{tabular}

\hspace*{0.2in}\begin{tabular}{rll@{\hspace*{2em}}l@{\hspace*{2em}}l}
\hspace*{0.8in} & \hspace*{1.0in} & \hspace*{0.6in} & \hspace*{0.6in} \\[-2ex]
+5100	& \ttkey{product}	& \TT{infix}	& \ttkey{/}	& division \\
+5200	& \ttkey{product}	& \TT{infix}	& \ttkey{*}
							& multiplication \\
+5300	& \ttkey{product}	& \TT{infix}	& \ttkey{\^~}
							& exponentiation \\
\end{tabular}

\hspace*{0.2in}\begin{tabular}{rll@{\hspace*{2em}}l@{\hspace*{2em}}l}
\hspace*{0.8in} & \hspace*{1.0in} & \hspace*{0.6in} & \hspace*{0.6in} \\[-2ex]
none	& none			& \TT{prefix}	&  \ttkey{-}	& minus \\
	& 			& \TT{prefix}	&  \ttkey{+}	& plus \\
	& 			& \TT{prefix}	&  \ttkey{@}	& object
	                                                          identifier \\
none	& \ttkey{subscript}	& \TT{postfix}	&  \ttkey{[...]}
								& subscript \\
\end{tabular}
...
operator parsing instruction whose name begins at the scan point.
Some instructions are rejected on the basis of their kind and
...
a just-recognized prefix operator, etc.  If there are non-rejected
instructions, those with the longest names beginning at the scan
point are selected, and among these, the one earliest in the list
is used.  Unless that instruction has the undefined flag, in which case the
...
A {\em operator-parsing-instruction} may associate an
{\em operator-reformatter} with an operator.  After parsing a list,
if the first operator in a resulting expression has an
associated {\em operator-reformater}, the expression is reformatted
...
addition the operator `\TT{/}' has the same {\em operator-precedence}
...
\hspace*{-0.3in}\ttkey{infix} \\
Only allowed for operators of `\TT{infix}' kind (so the expression
must have alternating operands and operators and must begin and end
with an operand).
...
Empty lists (i.e., \TT{\{||\}} lists) are inserted so that all
the operators become infix.
Then all the operators are removed and the \TT{operator-name} is made
into the value of the `\TT{.separator}' property of the list.

Thus if `{,}' is a nofix operator with this reformatter,
the expression
\begin{center}
\tt , w x,, y, z,
\end{center}
...
and a \key{reformater construction instruction} of the form: 

\begin{tabular}{rcl}
\hspace*{1.0in} \\[-2ex]
\multicolumn{3}{l}{\emkey{reformatter-construction-instruction}} \\
    & ::= & \TT{\{ reformatter construction instruction:} \\
    &     & ~~~ \TT{name =} {\em constructed-reformatter-name}\TT{,} \\
    &     & ~~~ \TT{constructor =} {\em reformatter-constructor-name}\TT{,} \\
    &     & ~~~ \TT{arguments =} {\em reformatter-argument-list} \\
    &     & \TT{||\}} \\
\end{tabular}

\begin{tabular}{rcl}
\hspace*{1.7in} \\[-2ex]
\emkey{constructed-reformatter-name}
    & ::= & {\em word}\PLUS{} \\
\emkey{reformatter-constructor-name}
    & ::= & \TT{infix-to-and} $|$ \TT{summation} \\
\emkey{reformatter-argument-list}
    & ::= & \TT{(} {\em reformatter-argument}
            \{ \TT{,} {\em reformatter-argument} \}\STAR{} \TT{)} \\
\emkey{reformatter-argument}
    & ::= & {\em word}\PLUS{} \\
\end{tabular}

A {\em quoted-symbol} {\em word} in a {\em reformatter-argument} represents
the {\em symbol} quoted.  E.g., \TT{"+"} and \TT{+} are equivalent
(but \TT{""+""} represents \TT{"+"} for what its worth).
...
\hspace*{-0.3in}\ttkey{infix-to-and} \TT{(} {\em and-op} \TT{)} \\
Only allowed for operators of `\TT{infix}' kind (so the expression
must have alternating operands and operators and must begin and end
with an operand).
