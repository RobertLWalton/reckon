...
\begin{indpar}
\begin{verbatim}
define lexeme dictionary NAME ENTRIES <-- tuple ENTRIES
...
An {\em IMMU\-TABLE-CONTEXT} is defined by the
expression definitions (\secref{EXPRESSION-DEFINITIONS}):

\begin{indpar}
\begin{verbatim}
a context {
    a context CONTEXT-ITEM-LIST <--
              tuple CONTEXT-ITEM-LIST of context-items {...}
}
context-item X <-- expression-definition X
context-item X <-- context X
context-item X <-- immutable-context X
\end{verbatim}
\end{indpar}
