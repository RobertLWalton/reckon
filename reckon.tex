...
is split into a {\em pre-word} and a {\em post-separator}
if the {\em post-separator-character} is strong, or if
the split-out {\em pre-word} is a {\em number}, or if
the split-out {\em pre-word} does 
