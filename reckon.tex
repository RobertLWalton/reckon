...
\verb|-|,
\verb|*|,
\verb|/|), or certain matching lexemes.  A \key{raw expression}
is an expression that will not be restructured.  Translating
an expression into a raw expression is called \key{parsing}.

Some matching lexemes
that are used to bracket subexpressions affect parsing:
