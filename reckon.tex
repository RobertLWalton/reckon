...
gets the attribute value from the surrounding text, or from an
...
`\verb/<p>/' is a lower precedence operator than `\verb/<section>/', and
...
operator.  The `\verb/<section>/' operator above is used in its
bracket form `\verb/<section|/ \ldots{} \verb/|>/' to attach a {\tt .title} to
the text of {\tt .text-type section}. 
...
\ttmkey{text-prefix}{reformatter} \hfill \OP{section} ~~~ \OP{li} ~~~ \OP{p}
