...
with `\ttkey{\#}',
evaluate the value of that variable, and replace this value node
by the value obtained.  The order in which these variable evaluations are done
is implementation dependent.  Any side effects of the evaluations
TBD

\item
Evaluate each guard of the definition in order.  If any fail to evaluate to
`\verb|true|', the definition does not apply.
...
Design: Th debugging design is based on the notion that almost all
