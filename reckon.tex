...
\emkey{units-subexpression}
    & ::= & \begin{tabular}[t]{l}
            {\em unit-prefix-subexpression}\QMARK{} \\
            {\em unitless-name}
            {\em unit-suffix-subexpression}\QMARK{} \\
	    \end{tabular}
\\[1ex]
\emkey{unitless-name} & ::= & \begin{tabular}[t]{l}
...
\\[1ex]
\emkey{unit-postfix-subexpression} & ::= & {\em postfix-unit}\PLUS{} \\
                                   & $|$ & {\em postfix-unit}\STAR{}
					   \TT{per}
...
\\[1ex]
\emkey{unit-expression} & ::= & {\em unit-primary}
				\{ \TT{*} {\em unit-primary} \}\STAR{} \\
			& $|$ & {\em unit-primary}
				\TT{/} {\em unit-primary}
\\[1ex]
\emkey{unit-primary} & ::= & {\em unit} \\
		     & $|$ & \TT{(} {\em unit-expression} \TT{)}
\end{tabular}
