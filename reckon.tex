...
\begin{tabular}{l}
\emkey{raw-list}
    ::= \TT{|} {\em raw-single-attribute-value}\STAR{} \TT{|} \\
\end{tabular}
...
{\em data-representations}.
Because lexemes like \TT{=} and \TT{|}
are avoided in attribute labels and in raw representation values,
the parser does little with attribute labels and attribute values.%
\label{RAW-PARSING}
The parser does, however, perform name mapping on attribute labels
and recognize and process {\em concatenated-quoted-stringss},
{\em scientific-numbers}, and {\em radix-numbers}.  In doing the
latter for a {\em raw-list}, the lexemes are in the list are scanned
...
The {\em raw-atoms} surrounded by `\TT{|}'s in a {\em raw-list}
...
{\em single-attribute-values} in a raw {\em data-representation}
