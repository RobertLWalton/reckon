...
Lexical Parsing includes the following:
...
Number Recognition (\secref{NUMBER-RECOGNITION}) \\
...
1.2.3	& 1.86,54	& 1,234567.892	& 12345.678,92	& 1.234567,892 \\[1ex]
\multicolumn{5}{l}{\normalfont (Lexemes in
the last line give errors when converted to numbers.)}
\end{tabular}
\end{indpar}

In a {\em decimal-number}, the decimal point must be followed by
a digit, and commas must be surrounded by digits.

Not all number lexemes are legal decimal numbers.
...
is \underline{not} a parsing error.  The last line of
...
B"5,7b63"	& O"2/3456"	& D"-0.1"	& X".E8A932B.7CCD" \\[1ex]
\multicolumn{4}{l}{\normalfont (Numbers in
the last line give errors when converted to internal numbers.)}
\end{tabular}
\end{indpar}
