...
\begin{indpar}
\begin{list}{}{}
\item[\ikey{Consistency Rules}{consistency rules}:]~
...
\begin{enumerate}
\item
If consistency was deduced according to Consistency Rule (5),
...
identical.
\item
If consistency was deduced according to Consistency Rule (6),
