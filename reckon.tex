...
\label{COMMENT}
\\[2ex]
\emkey{word-prefix-character} \begin{tabular}[t]{@{}r@{~}l@{}}
                     :::= \TT{.} & followed by a {\em letter} \\
		                 & and not preceeded by a {\em mark-character}
		     \end{tabular}
		     \\[1ex]
...
\emkey{mark-character} \begin{tabular}[t]{rl}
		     ...
		     $|$ & \TT{.} \begin{tabular}[t]{@{}l@{}}
		                  ...
		                  and either preceeded by
				             a {\em mark-character} \\
		                  or not followed by a {\em letter} \\
				  \end{tabular} \\
