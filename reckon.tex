...
The {\em operator-name} is matched to lexemes in a subexpression
...
and `{\tt nofix}'.  By default an operator is `{\tt nofix}'.
...
\begin{tabular}{rl@{\hspace*{2em}}l@{\hspace*{2em}}l@{\hspace*{2em}}l}

precedence & rerformatter	& operators	& type		& meaning 
\\[2ex]
-4000	& \ttkey{semicolon}	&  \ttnbkey{;}	& \tt nofix	& separator \\
-3000	& \ttkey{comma}		&  \ttnbkey{,}	& \tt nofix	& separator \\
+0000	& \ttkey{assign}	&  \ttnbkey{<-} 
				   		& \tt infix	& assignment \\
	&		        &  \ttkey{BECOMES} \\
+1000	& \ttkey{logical}	&  \ttkey{AND} ~~~
				   \ttkey{OR}	& \tt nofix	& logical and,
				   				  or, \\
	&			&  \ttkey{NOT}  &		& not \\
+2000 	& \ttkey{compare}	&  \ttnbkey{=} ~~~
				   \ttnbkey{/=} ~~~
        		           \ttnbkey{!=}	& \tt infix	& equal,
				   				  not equal,
								  ditto \\
	&		      	& \ttnbkey{<} ~~~
                                  \ttnbkey{<=} ~~~
	...
	&	      		&		&		& than or
      								  equal,
								  ditto \\
+3000	& \ttkey{sum}		&  \ttnbkey{+} ~~~
				   \ttnbkey{-}	& \tt infix	& addition,
				   				  subtraction \\
+3100	& \ttkey{product}	&  \ttnbkey{*} ~~~
				   \ttnbkey{/}	& \tt infix	&
				   				multiplication,
				   				  division \\
+9999	& \ttkey{minus}		&  \ttnbkey{-}	& \tt prefix	& minus \\
+9999	& \ttkey{plus}		&  \ttnbkey{+}	& \tt prefix	& plus \\
+9999	& \ttkey{objname}	&  \ttnbkey{@}	& \tt prefix	& object name \\
\end{tabular}
