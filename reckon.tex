...
is merging.  A node N passes an arity check if and only if
...
\item
For every natural number I from `\verb|0|' through A
there is exactly one arrow sourced at N such that either
the arrow label is I or the arrow label is `J\verb|-|K' where
J and K are natural numbers and J$<$K, J$\leq$I$\leq$K.
...
\item
There may be any number of arrows sourced N labeled
...
\item
There are no arrows sourced at N other than those enumerated above.
