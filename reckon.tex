...
syntax expression if that latter is just a sequence of atoms and
bracketed sublists.  Provided this sequence is surrounded by atoms
and non-parenthesis brackets that match pattern elements.
For example,
