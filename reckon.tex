...
\emkey{scientific-number} := {\em sign}\QMARK{} {\em scientific-numeric}
			     {\em exponent}\QMARK{}
\label{SCIENTIFIC-NUMBER}\\[1ex]
\emkey{sign} ::= \TT{+} $|$ \TT{-} \\[1ex]
\emkey{scientific-numeric} ::= {\em natural-number}
       $|$ {\em natural-number}\TT{.}{\em natural-fraction} \\[1ex]
\emkey{natural-number} ::= {\em digit}\PLUS{}
	$|$ {\em digit}\QMARK{} {\em digit}\QMARK{} {\em digit}
	    \{ \TT{,} {\em digit} {\em digit} {\em digit} \}\PLUS{} \\[1ex]
\emkey{natural-fraction} ::= {\em digit}\PLUS{}
