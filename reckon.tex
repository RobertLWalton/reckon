...
\skey{symbol}s\label{SYMBOL} which store character strings.
...
\emkey{word} ::=
    ...
    and & (4) & does not have any digit adjacent to a character \\
        &     & that is neither a letter or a digit \\
    \end{tabular}
    \end{tabular}
\\[1ex]
\emkey{numeric} ::=
    ...
    and & (3) & does not begin or end with any of
                \TT{<} \TT{>} \TT{\textbackslash} \TT{/}
    \end{tabular}
    \end{tabular}
\\[1ex]
