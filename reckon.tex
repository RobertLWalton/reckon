...
See \secref{DEFAULT-SYNTAX-VARIABLES} for examples.
...
See \secref{OPTIONAL-TRUTH-VALUE-SYNTAX-VARIABLES} for examples.

\item A {\em pattern-clause} followed by `\verb|...|'
in the {\em pattern} is a \key{repeated pattern clause}
and must appear one or more times
in the represented {\em syntax-expression}.
See \secref{REPEATED-SYNTAX-VARIABLES} for examples.
...
Note that this resultes in pattern equations and \underline{not}
syntax equations.
