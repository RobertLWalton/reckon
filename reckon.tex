...
\subsubsubsection{Bracket Name}\ttmindex{name}{of bracket}
\label{BRACKET-NAME}
...
\subsubsubsection{Bracket Parser}\ttmindex{parser}{of bracket}
...
The \verb|parser| of a bracket definition is an optional \verb|[ ]|
bracketted list that names a parser.  If present, a {\em PARSER-DEFINITION}
...
The \key{operators parser}, \ttnbbkey{OPERATORS PARSER}.
All parsing definitions with the \ttnbflagkey{OPERA\-TOR} are recognized.

The \key{list parser}, \ttnbbkey{LIST PARSER}.
All parsing definitions with the \ttnbflagkey{LIST} are recognized.

The \key{text parser}, \ttnbbkey{TEXT PARSER}.
All parsing definitions with the \ttnbflagkey{TEXT} are recognized.
The special constructs of text parsing (\secref{TEXT-PARSING}) are
recognized.

\end{indpar}

\subsubsubsection{Bracket Evaluator}\ttmindex{evaluator}{of bracket}
