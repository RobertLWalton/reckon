...
Some examples are:
\begin{center}
\TT{1/3}~~~~~~\TT{+48/97}~~~~~~\TT{42\_3/8}~~~~~~\TT{-10\_7/10}.
\end{center}
...
{\em radix-indicator}, and the
permissible {\em digits} and comma spacings depend upon this indicator:

\begin{indpar}
\emkey{radix-numeric} ::= \\
\hspace*{0.2in}
    {\em sign}\QMARK{} {\em radix-indicator}
...
\\[1ex]
\emkey{radix-fractional-part} :::= {\em radix-digit}\PLUS{}
	    \{ \TT{,} {\em radix-digit}\PLUS{} \}\STAR{} ~~~ [see text]
\\[1ex]
\emkey{exponent-part} ::= {\em exponent-indicator} {\em sign}\QMARK{}
                          {\em digit}\PLUS{} \\[1ex] 
...
is not allowed with \TT{B\#} and the digit \TT{E} is not allowed
with \TT{D\#}.  Only certain comma spacings are permitted, and comma
...
\begin{indpar}\begin{verbatim}
    define time zone MIT `Midway Islands Time'        UTC-11:00
    define time zone HST `Hawaii Standard Time'       UTC-10:00
    define time zone AST `Alaska Standard Time'       UTC-09:00
    define time zone PST `Pacific Standard Time'      UTC-08:00
    define time zone PNT `Phoenix Standard Time'      UTC-07:00
    define time zone MST `Mountain Standard Time'     UTC-07:00
    define time zone CST `Central Standard Time'      UTC-06:00
    define time zone EST `Eastern Standard Time'      UTC-05:00
    define time zone PRT `Puerto Rico Time'           UTC-04:00
    define time zone CNT `Canada Newfoundland Time'   UTC-03:30
    define time zone AGT `Argentina Standard Time'    UTC-03:00
    define time zone BET `Brazil Eastern Time'        UTC-03:00
    define time zone CAT `Central African Time'       UTC-01:00
    define time zone GMT `Greenwich Mean Time'        UTC+00:00
    define time zone WET `Western European Time'      UTC+00:00
    define time zone MET `Middle European Time'       UTC+01:00
    define time zone EET `Eastern European Time'      UTC+02:00
    define time zone ART `Arabic Standard Time'       UTC+02:00
    define time zone EAT `Eastern African Time'       UTC+03:00
    define time zone MET `Middle East Time'           UTC+03:30
    define time zone NET `Near East Time'             UTC+04:00
    define time zone PLT `Pakistan Lahore Time'       UTC+05:00
    define time zone IST `India Standard Time'        UTC+05:30
    define time zone BST `Bangladesh Standard Time'   UTC+06:00
    define time zone VST `Vietnam Standard Time'      UTC+07:00
    define time zone CTT `China Taiwan Time'          UTC+08:00
    define time zone JST `Japan Standard Time'        UTC+09:00
    define time zone ACT `Australia Central Time'     UTC+09:30
    define time zone AET `Australia Eastern Time'     UTC+10:00
    define time zone SST `Soloman Standard Time'      UTC+11:00
    define time zone NST `New Zealand Standard Time'  UTC+12:00
    $|$ & \TT{WAT} $|$ \TT{BT} $|$ \TT{CCT} \\
    $|$ & \TT{IDLE} $|$ \TT{IDLW} \\
    $|$ & \TT{JST} $|$ \TT{JDT} \\
    $|$ & \TT{GST} $|$ \TT{GDT} \\
...
\end{center}
translates as (see \itemref{SCIENTIFIC-NUMERIC}):
\begin{center}
\tt
