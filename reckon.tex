...
The reorder mark (\verb|<=>|) separates arguments that can be
reordered, as in \verb|element LIST <=> INDEX|.
The qualifier mark (\verb|@@@|) signals that the following
...
\verb|[]|  & eval, operators, qualifiers, \verb/|/, text
					& \verb|<=>|, \verb|@@@| \\
...
From the parsing point of view there are three kinds of contexts:
...
Also from the parsing point of view there are several types of
...
restructuring, which is always on when text restructuring is
