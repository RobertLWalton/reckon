...
\emkey{atom-name}
    ...
    ::= & {\em word} \\
    $|$ & {\em quoted-string} \\
    $|$ & {\em fractional-number}\pagnote{FRACTIONAL-NUMBER} \\
    $|$ & {\em scientific-number}\pagnote{SCIENTIFIC-NUMBER} \\
    $|$ & {\em date}\pagnote{DATE} \\
    $|$ & {\em time}\pagnote{TIME} \\
    $|$ & {\em concatenated-quoted-string}%
          \pagnote{CONCATENATED-QUOTED-STRING} \\
    $|$ & {\em radix-number}\pagnote{RADIX-NUMBER} \\
    \end{tabular}
\label{ATOM-NAME}
\end{indpar}
