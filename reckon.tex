...
are the output of the lexical parser for each non-blank line, and 
...
to the lines read so far at top level, and line list equal to what has been
read for far from the current line.
...
definition, indentation mark definition, subexpression list, etc., there
...
are referred to as the current input lexemes, and the first of these is
...
{\bf Indentation Mark Ungluing Step.}%
\index{Indentation Mark Ungluing Step}
\begin{indpar}
If
\begin{list}{}
	     {\setlength{\itemsep}{0ex}%
...
lexemes becomes the current input lexeme, and the second becomes the
next lexeme in the input.
\end{indpar}

{\bf Indented Line Termination Step.}\index{Indented Line Termination Step}
\begin{indpar}
If
\begin{list}{}
	     {\setlength{\itemsep}{0ex}%
...
{\bf Indented Subexpression Termination Step.}%
\index{Indented Subexpression Termination Step}
\begin{indpar}
If
\begin{list}{}
	     {\setlength{\itemsep}{0ex}%
...
{\bf Bracketted Subexpression Termination Step.}%
\index{Bracketted Subexpression Termination Step}
\begin{indpar}
If
\begin{list}{}
	     {\setlength{\itemsep}{0ex}%
	      ...
	      \setlength{\leftmargin}{0.5in}%
	      \setlength{\rightmargin}{0.5in}}%
\item[(1)] there is a current bracket definition
\item[(2)] the closing bracket in that definition matches a sequence
of lexemes at the beginning of the current input lexemes
\end{list}
then the current subexpression record is popped from the subexpression
stack and its subexpression list is added as a single element to the
new current line list.
The closing bracket is removed from the current input lexemes and
discarded.
Then this loop iteration is terminated.
\end{indpar}

{\bf Indentation Initiation Step.}%
\index{Indentation Initiation Step}
\begin{indpar}
If
\begin{list}{}
	     {\setlength{\itemsep}{0ex}%
	      ...
	      \setlength{\rightmargin}{0.5in}}%
\item[(1)] the current input lexeme is the first lexeme on its line,
\item[(2)] there is a current indentation mark definition,
...
{\bf Indented Line Initiation Step.}%
\index{Indented Line Initiation Step}
\begin{indpar}
If
\begin{list}{}
	     {\setlength{\itemsep}{0ex}%
...
{\bf Indented Subexpression Initiation Step.}%
\index{Indented Subexpression Initiation Step}
\begin{indpar}
If
\begin{list}{}
	     {\setlength{\itemsep}{0ex}%
...
The indentation mark is removed from the current input lexemes and
discarded.
Then this loop iteration is terminated.
\end{indpar}

{\bf Bracketted Subexpression Initiation Step.}%
\index{Bracketted Subexpression Initiation Step}
\begin{indpar}
If
\begin{list}{}
	     {\setlength{\itemsep}{0ex}%
...
initial sequence in the current input lexemes,
\end{list}
then a new subexpression record is pushed into the subexpression stack.
...
The opening bracket is removed from the current input lexemes and
discarded.
Then this loop iteration is terminated.
\end{indpar}

{\bf Lexeme Consumption Step.}%
\index{Lexeme Consumption Step}
\begin{indpar}
The current input lexeme is removed from the current input lexemes and
