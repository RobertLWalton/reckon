...
Before a primary is parsed, lexeme-splitting and unit grouping
operations are performed on the parts of the primary outside
brackets.
...
in a primary:
\begin{indpar}
\emkey{spitable-lexeme} :::= \\
\hspace*{1in}\begin{tabular}{rl}
{\em word} & \TT{'s} \\
{\em number} & {\em unit} \\
{\em fraction} & {\em unit} \\
\end{tabular}
...
{\em splitable-lexeme} thereby spliting it into two lexemes.
