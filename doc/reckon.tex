...
\begin{indpar}
    \begin{tabular}[t]{l@{~~~~~}lll}
          & Section & Example & When Inside \\[1ex]
      {\em label-value}
    & \itemref{LABEL-EXPRESSION}
    & \TT{[<} {\em label-expression} \TT{>]}
    \\
      {\em parenthesized-expression}
    & \itemref{CODE-EXPRESSION}
    & \TT{(} {\em code-expression} \TT{)} & {\em code-expression} \\
    & \itemref{MATH-EXPRESSION}
    & \TT{(} {\em math-expression} \TT{)} & {\em math-expression} \\
    & \itemref{TEXT-EXPRESSION}
    & \TT{(} {\em phrase-expression} \TT{)} & {\em text-expression}
    \\
      {\em math-value}
    & \itemref{MATH-EXPRESSION}
    & \TT{\{\{} {\em math-expression} \TT{\}\}}
    \\
      {\em code-value}
    & \itemref{CODE-EXPRESSION}
    & \TT{[} {\em code-expression} \TT{]}
    \\
    \end{tabular}
\end{indpar}
