...
\emkey{strict-separator-character} :::= {\em singleton-separator-character}
				           ...
				           \TT{|}
\\[0.5ex]
\emkey{singleton-separator-character} :::=
    \begin{tabular}[t]{@{}l}
...
A \key{number pair} is a pair of {\em numerics}, the first
of which is in integer and the second of which is a fraction
containing a slash.

\begin{indpar}
\emkey{number-pair} ::= {\em integral-numeric} {\em fractional-numeric}
    \\[1ex]
{\em integral-numeric} ::= see \pagref{INTEGRAL-NUMERIC} \\[1ex]
{\em fractional-numeric} ::= see \pagref{FRACTIONAL-NUMERIC}
\end{indpar}
...
{\em argument-list} ::= {\em empty}
    ...
    \\[1ex]
{\em argument} ::= {\em name} $|$ {\em numeric} $|$ {\em quoted-string}
    \\[1ex]
