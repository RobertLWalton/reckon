...
\end{verbatim}\end{indpar}
there are only 3 logical lines: the apparent logical line following the second
`\TT{;}' is empty and is ignored.
However, a logical line ending with a `\TT{;}' is not ignored, even
if it is otherwise empty.  Thus in
\begin{indpar}\begin{verbatim}
This is a first logical line;;
a third logical line; and a forth logical line
\end{verbatim}\end{indpar}
there are three 4 lines, the second containing just its ending `\TT{;}'.
