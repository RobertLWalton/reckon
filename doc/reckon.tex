...
\subsection{Times of Day}
\label{TIMES-OF-DAY}

A \key{time-of-day} is a time interval paired with a time zone.
The time zone acts something like a {\em unit-name}, but also
sometimes acts like the specific {\em unit-name} `\TT{sec}'
(for seconds).
...
\key{Times}, \key{times of day}, and \key{time intervals}
