...
A `\TT{:}' or `\TT{::}'
lexeme at the end of a physical line begins an
...
And a logical line ending with an indented paragraph:
    ...
    The third logical line of the indented
        ...
        subparagraph:
        // A warning message will be issued for these
        // comment lines as they have less indent than
        // what follows them.
...
occurs first.
An indented paragraph is always the last thing in the logical line that
contains its beginning `\TT{:}' or `\TT{::}'.

The top level is similar to an indented paragraph with paragraph indent \TT{0}.
