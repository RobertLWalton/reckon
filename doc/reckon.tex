...
\begin{center}
    ...
    \\
      {\em math-constant}
    & \itemref{MATH-CONSTANT}
    & \TT{\{\{ 2 * x \CIRCUM{} 2 + 6 * x + 3 \}\}} 
    \\
      {\em phrase-constant}
    & \itemref{PHRASE-CONSTANT}
    & \TT{`John Doe'}
    \\
      {\em sentence-constant}
    & \itemref{SENTENCE-CONSTANT}
    & \TT{``All men do what?''}
    \\
      {\em subscript}
    & \itemref{SUBSCRIPT}
...
\TT{label} & {\em label-constants } \\
\TT{code} & executable code \\
\TT{math} & {\em math-constants } \\
\TT{text} & text constants \\
\end{tabular}
\end{center}
...
\TT{[<\ldots>]} & all & \TT{label} & {\em label-constant} \\
\TT{[\$\ldots\$]} & all & \TT{data} & {\em special-value} \\
\TT{(\ldots)} & all & unchanged & {\em parenthesized-expression} \\
\TT{\{\{\ldots\}\}} & \TT{code}, \TT{text} & \TT{math} & {\em math-constant} \\
\TT{`\ldots'} & \TT{code}, \TT{text} & \TT{text} & {\em phrase-constant} \\
\TT{``\ldots''} & \TT{code}, \TT{text} & \TT{text} & {\em sentence-constant} \\
