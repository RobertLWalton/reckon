...
A \key{symbol} is a character string that can be represented by
a {\em word}, {\em numeric}, or {\em quoted-string} (but \underline{not}
by a {\em mark})\pagnote{LEXEME-SYNTAX}.
...
However, as a place in memory, an object has a identifier.
