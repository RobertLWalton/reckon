...
\underline{two} identical double attributes (two double headed pointers with the
...
An {\em attribute-value} that is a sequence of two or more strings or numbers
