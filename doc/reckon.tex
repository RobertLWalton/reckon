...
\emkey{date-name} \begin{tabular}[t]{rl}
	     :::= & {\em year} \TT{-} {\em month} \TT{-} {\em day} \\
	      $|$ & {\em year}  \TT{-} {\em day-of-year} \\
	      $|$ & {\em month-name} \TT{-} {\em year} \\
	      $|$ & {\em month-name} \TT{-} {\em day} \TT{-} {\em year} \\
	     \end{tabular}
\\[1ex]
\emkey{year} :::=  {\em long-year} $|$ {\em year-name}
\\[1ex]
\emkey{long-year} :::=  {\em dit} {\em dit} {\em dit} {\em dit}
\\[1ex]
\emkey{year-name} :::= {\em dit}\PLUS{} {\em era}
\\[1ex]
\emkey{month} :::=  {\em dit} {\em dit} $|$ {\em month-name}
\\[1ex]
\emkey{month-name} :::= [first letter or whole word may be capitalized] \\
    ...
    \end{tabular}
\\[1ex]
\emkey{day} :::=  {\em dit} {\em dit}
\\[1ex]
\emkey{day-of-year} :::=  {\em dit} {\em dit} {\em dit}
\\[1ex]
