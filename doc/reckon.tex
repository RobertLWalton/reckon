...
This is a line of code.  If it was not preceeded by
     or begun with `{code}', it would begin with
...
In this example each logical line is itself a headed line,
with `\TT{\{row\}}' being its line header.

In this particular case the headers may be omitted because
