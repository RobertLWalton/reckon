...
lengthened slightly, following Google.}  The value \TT{0} is assigned to
...
\emkey{date} \begin{tabular}[t]{rl}
	      ...
	      $|$ & {\em year-with-era} ~ {\em day-of-year}\QMARK{} \\
	     \end{tabular}
\label{DATE}
\\[1ex]
\emkey{date-name} \begin{tabular}[t]{rl}
	     :::= & {\em year-name} \TT{-} {\em month-name}
	     	                    \TT{-} {\em day-name} \\
	      $|$ & {\em year-name}  \TT{-} {\em day-of-year-name} \\
	      $|$ & {\em month-word} \TT{-} {\em year-name} \\
	      $|$ & {\em month-word} \TT{-} {\em day-name}
	                             \TT{-} {\em year-name} \\
	     \end{tabular}
\\[1ex]
\emkey{year} :::=  {\em integer} {\em era}\QMARK{} $|$ {\em year-name}
\\[1ex]
...
\\[1ex]
\emkey{month} :::=  {\em integer} $|$ {\em month-name}
\\[1ex]
