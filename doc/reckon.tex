...
However, in addition to logical lines, these can contain headed paragraphs
and headed lines which contain text or data.

A paragraph or line header has the syntax:
\begin{indpar}
\begin{tabular}{l}
...
that is just after a blank line, the beginning of the file, or the
...
lines up to the next non-blank line, the end of the file, or the end
