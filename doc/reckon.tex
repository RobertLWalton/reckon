...
the date with day value \TT{0}).  \skey{UTC second}s are such that
each day has \TT{86,400} = 24*60*60 UTC seconds.  However, to make
this true, some UTC seconds have to be lengthened or shortened.

Most UTC seconds are the same as \skey{TAI} seconds (International
...
\skey{leap second}s, are double length or zero length.  
