...
Blank lines and comments that are within a logical line are ignored
as if they did not exist.  Aside from rules regarding indentation,
...
Indented paragraphs are contained with a logical line.  It is a semantic
(not parsing) error if they are not the last thing in their logical line.

TBD

Both the top level and indented paragraphs can contain \skey{typed paragraph}s.
There are two kinds of typed paragraphs, code and text.
