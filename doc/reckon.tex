...
Note that in a name digits can appear after letters, in
{\em natural-indices} do not begin the name, or inside quotes,
...
A \emkey{radix-number} is the same as a {\em scientific-number},
