...
label.  An example of this, in which object \TT{@<X>} has two
...
\put(0.3,1.00){\makebox(2.4,0.3){\tt @<X>}}
...
\put(0.3,0.10){\makebox(0.8,0.3){\tt @<Y>}}
\put(0.7,0.25){\oval(0.8,0.3)}
\put(1.9,0.10){\makebox(0.8,0.3){\tt @<Z>}}
\put(2.3,0.25){\oval(0.8,0.3)}
\end{picture}
\end{tabular}
\end{center}

We say that the value of the \TT{child} attribute of \TT{@<X>} is
the set to two elements, \TT{@<Y>} and \TT{@<Z>}.
