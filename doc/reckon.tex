...
if the first ends with \TT{\#} and the second begins with \TT{\#}.
...
a \TT{\#} or \TT{\#\#} mark lexeme, the strings
are concatenated \underline{after} {\em character-represen\-ta\-tives}
have been replaced by the characters they represent.  The separating \TT{\#}
or \TT{\#\#}
lexeme is deleted.  More than two {\em quoted-strings} may be concatenated
together in this way.
...
By rule \ref{MIDDLE-LEXEME-CONCATENATION} above,
two consecutive \TT{\#} lexemes will be concatenated into a single
\TT{\#\#} lexeme before this current rule is applied.
Thus the following multi-line string concatenation example:
\begin{indpar}\begin{verbatim}
x = "This is a long "#
   #"sentence."
\end{verbatim}\end{indpar}
