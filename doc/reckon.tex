...
\begin{indpar}[1em]
A non-header prefix can appear
after immediately a header in a logical line, and also anywhere
after an occurance of a prefix of the same {\em bracket-type}
