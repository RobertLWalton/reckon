...
and \TT{\{b|\ldots|b\}}, \TT{b} becomes the value of the \TT{.type}
attribute.
But if the {\em type-name}
is completely missing (as in \TT{\{|\ldots|\}}) or
...
of the object's \TT{.type} attribute.  If different {\em type-marks}
...
\item {\em Prefixes}\pagnote{PREFIXES} are not recognized as such in the
{\em vector-element-list}.  Instead they simply represent objects
