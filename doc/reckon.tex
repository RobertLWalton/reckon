...
comment lexemes.  Such a line is called a \key{comment line}.  A comment
...
is not indented more than the current paragraph
indent.
...
be `\TT{\{quote: indent = 5\}}'.  The `\TT{\{section\}}' paragraph
header does \underline{not} install an implied paragraph header.

To end text, it is necessary
